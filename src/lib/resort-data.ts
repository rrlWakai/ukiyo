...
export const eventPackages: EventPackage[] = [
  {
    id: 'event-stay-lite',
    name: 'Garden Event Package',
    subtitle: 'For intimate birthdays, baptisms, and simple celebrations.',
    price: 18000,
    pax: '30-50 pax',
    description:
      'A practical event setup with room use, pool access, and enough flexibility for half-day functions.',
    features: [
      '4 hours venue use',
      '1 day-use room',
      'Pool access for confirmed guests',
  ...
  {
    id: 'event-stay-plus',
    name: 'Poolside Celebration Package',
    subtitle: 'For mid-size celebrations that want a more complete resort experience.',
    price: 32000,
    pax: '50-80 pax',
    description:
      'Our most requested package for birthdays and corporate socials with more hours and upgraded inclusions.',
    features: [
      '6 hours venue use',
      '1 overnight Lanai or Veranda room',
      'Semi-exclusive pool access',
      'Tables and chairs setup',
      'Coordination support',
      'Basic sound system area',
    ],
    featured: true,
  },
  {
    ...
    subtitle: 'For weddings, reunions, and large private events.',
    price: 58000,
    pax: '80-120 pax',
    description:
      'A private-use resort setup with expanded access, multiple rooms, and event-ready coordination support.',
    features: [
      '8 hours venue use',
      '2-4 rooms or villa allocation',
      'Exclusive pool use',
      'Dedicated event flow support',
      'Extended ingress and egress window',
      'Best for full-property events',
    ],
  },
]
